...
@RestController
@RequestMapping("/api/editique-sample-application-kafka")
public class EditiqueSampleApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EditiqueSampleApplicationKafkaResource.class);
    ...
    public EditiqueSampleApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
